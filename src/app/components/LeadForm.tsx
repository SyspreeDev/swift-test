...
export function LeadForm({ autoOpen = false }: { autoOpen?: boolean }) {
  ...
  const renderStep = () => {
    switch (currentStep) {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-4">
              {projectTypes.map((type) => (
                ...
                >
                  ...
                  <div
                    className={`font-['Inter',sans-serif] text-base lg:text-lg font-medium ${
                      formData.projectType === type.value
                        ? "text-[#008873]"
            ...
            <div className="grid grid-cols-2 gap-3 lg:gap-4">
              {propertyTypes.map((type) => (
                ...
                >
                  ...
                  <div
                    className={`font-['Inter',sans-serif] text-sm lg:text-base font-medium ${
                      formData.propertyType === type.value
                        ? "text-[#008873]"
                        : "text-[#1c1c1e] group-hover:text-[#008873]"
                    }`}
      ...
      case 2:
        return (
          <div key="step-2" className="space-y-4 lg:space-y-6">
            <div>
              ...
              {products.map((product) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`font-['Inter',sans-serif] text-xs lg:text-base font-medium leading-tight ${
                        isSelected
                          ? "text-[#008873]"
                          : "text-[#1c1c1e] group-hover:text-[#008873]"
                      }`}
    ...
    <>
      ...
      {isFormOpen && (
        ...
        >
          ...
          <div className="relative min-h-[300px]">{renderStep()}</div>
